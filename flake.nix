{
  ...
  outputs = {
    ...
    with nixpkgs.lib; let
      ...
      # kami-chan-server-installer should support all 64-bit systems supported by go, but nix only
    ...
    in {
      # kami-chan-server-installer package
      ...
      in rec {
        ...
        # Build kami-chan-server-installer by default when no package name is specified
        default = kami-chan-server-installer;
      });
